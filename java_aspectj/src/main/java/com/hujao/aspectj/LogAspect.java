...
public class LogAspect {
	...
	@Pointcut("execution(public * com.hujao.rest..*.*(..))")
	public void restLog(){}
	@Around("restLog()")  
	...
	@Pointcut("execution(public * com.hujao.domainservice..*.*(..))")
	...
	@Pointcut("execution(public * com.hujao.dataaccess..*.*(..))")
